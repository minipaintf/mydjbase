...
DATABASES = {
    'default': {
        ...
        'NAME': 'django_fp_test',                      # Or path to database file if using sqlite3.
        'USER': 'dev_user',                      # Not used with sqlite3.
        'PASSWORD': 'dev_pass',                  # Not used with sqlite3.
...
SECRET_KEY = 'p3a*9e=&amp;x=n3n6##slc=91$jv8umjqp58zp5$rbyg0396vve!o'
